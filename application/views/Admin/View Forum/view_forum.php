			...
			<div class="container-field">
				<div class="col-lg-12">
					...
					<?php foreach($topik as $u) { ?>
							...
							<?php if ($u->id_topik == $dt->id_topik) : ?>
								<div class="nav-item dropdown" style="float: right">
									...
									<div class="dropdown-menu">
										...
										<center>
										<a href="<?= base_url('topics/hapus/'.$u->id_topik) ?>" class="fa fa-trash" id="tombol-hapus">
											Delete
										</a>
										</center>
									</div>
						...
						<div class="col-lg-10">
							<form action="<?php echo site_url('masterkomentar/tambah/')?>" method="post">
								<div class="form-group pl-10">
									...
									<div class="card card-body">
										...
										<div class="form-floating" style="width:700px">
											<input class="form-control" id="isi_komentar" name="isi_komentar" required>
					...
					<?php foreach($komentar as $k) { ?>
						...
						<div class="form-floating" style="width:700px">
							...
							<div style="float: right">	
								...
								<div class="dropdown-menu">
									<center>
									<a href="<?= base_url('masterkomentar/view_ubah/'.$k->id_komentar) ?>" class="fa fa-edit" >
											Edit
										</a>
									</center>
									<hr class="dropdown-divider">
									<center>
									<a href="<?= base_url('masterkomentar/hapus/'.$k->id_komentar) ?>" class="fa fa-trash" id="tombol-hapus">
											Delete
										</a>
									</center>
								</div>
							...
							<div class="collapse" id="collapseExample<?php echo $k->id_komentar ?>">
								...
								<!-- Form Input balasan -->
								<form action="<?php echo site_url('masterbalasan/tambah')?>" method="post">
									<input type="hidden" name="id_topik" value="<?php echo $u->id_topik ?>">
									...
									<div style="display: flex;">
										...
										<div class="form-floating" style="width:940px">
											...
											<a class="fa fa-ellipsis-v" data-bs-toggle="dropdown"></a>							
												<div class="dropdown-menu">
													<center>
													<a href="<?= base_url('masterbalasan/view_ubah/'.$b->id_balasan) ?>" class="fa fa-edit" >
															Edit
														</a>
													</center>
													<hr class="dropdown-divider">
													<center>
													<a href="<?= base_url('masterbalasan/hapus/'.$b->id_balasan) ?>" class="fa fa-trash" id="tombol-hapus">
															Delete
														</a>
													</center>
												</div>
